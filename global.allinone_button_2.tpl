...
<div class="fab-wrapper">
   ...
   <div class="fab-wheel">
		<!-- BEGIN: maps -->
      <a class="fab-action fab-action-1" href="{DATA.maps}" rel="nofollow" target="_blank">
         <span class="fab-title">Chỉ đường</span>
         <div class="fab-button fab-button-1"><i class="icon-cps-local"></i></div>
      </a>
	  <!-- END: maps -->
	  <!-- BEGIN: hotline -->
      <a class="fab-action fab-action-2" href="tel:{DATA.hotline}" rel="nofollow">
         <span class="fab-title">Gọi trực tiếp</span>
         <div class="fab-button fab-button-2"><i class="icon-cps-phone"></i></div>
      </a>
	  <!-- END: hotline -->
	  <!-- BEGIN: facebook -->
      <a class="fab-action fab-action-3" href="https://www.facebook.com/{DATA.facebook}" target="_blank" rel="nofollow">
         <span class="fab-title">Chat facebook</span>
         <div class="fab-button fab-button-3"><i class="icon-cps-chat"></i></div>
      </a>
	  <!-- END: facebook -->
	  <!-- BEGIN: zalo -->
      <a class="fab-action fab-action-4" href="https://zalo.me/{DATA.zalo}" target="_blank" rel="nofollow">
